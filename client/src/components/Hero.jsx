    ...
    <div className='px-4 sm:px-20 xl:px-32 relative flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        ...
        <div className='text-center mb-6'>
            ...
            <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs mt-4'>
                <button onClick={() => navigate('/ai')} className='bg-primary text-white py-3 px-10 rounded-lg hover:scale-102 active:scale-95 transition cursor-pointer'>
                    Start Creating Now
                </button>
            ...
            <div className='flex items-center gap-4 mt-1 mx-auto text-gray-600'>
